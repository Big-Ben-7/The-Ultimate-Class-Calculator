...
def math24play():
    ...
    while True:
        ...
        print("Numbers: " + print_numbers[:len(print_numbers) - 2])
        while True:
            print()
            input_sol = input("Solution (i): ")
            if input_sol == "" or input_sol == "exi" or input_sol == "exit" or input_sol == "c" or input_sol == "cre" or input_sol == "create" or input_sol == "s" or input_sol == "sol" or input_sol == "solve" or input_sol == "o" or input_sol == "ope" or input_sol == "operations" or input_sol == "f" or input_sol == "fun" or input_sol == "functions":
                break
                ...
                continue
            sol = input_sol.replace("[", "(").replace("]", ")").replace("{", "(").replace("}", ")").replace(" ", "").replace("+", " + ").replace("-", " - ").replace("/", " / ").replace("*", " * ")
            ...
            print(valid)
            print(counter)
            print(counter_list.count(str(numbers[0])))
            print(counter_list.count(str(numbers[1])))
            print(counter_list.count(str(numbers[2])))
        ...
        if input_sol == "" or input_sol == "exi" or input_sol == "exit":
            break
        if sol == "c" or sol == "cre" or sol == "create":
            math24create()
            break
        elif sol == "s" or sol == "sol" or sol == "solve":
            math24solve()
            break
        elif sol == "o" or sol == "ope" or sol == "operations":
            real_operation()
            break
        elif sol == "f" or sol == "fun" or sol == "functions":
            polynomial()
            break
