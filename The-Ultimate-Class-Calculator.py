...
runs = 0
global keeps
keeps = ["ans", "pi", "e", "tau", "inf", "nan", "infj", "nanj", "keeps", "rl", "im", "im2", "mod", "ang", "rat", "root", "root2", "binsum", "dif", "problems", "runs"]
def clear_variables():
...
def math24play():
    ...
    while True:
        ...
        print()
        print(f"Problem {problems}: " + print_numbers[:len(print_numbers) - 2])
        ops = [" + ", " - ", " * ", " / "]
        solved = False
        for i in range(0, 11):
            if solved == True:
